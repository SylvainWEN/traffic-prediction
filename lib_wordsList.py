stopwords = ['a\'s','able','about','above','according','accordingly','across','actually','after','afterwards','again',
             ...
             't','t\'s','take','taken','tell','tends','th','than','thank','thanks','thanx','that','that\'s','thats',
             ...
             'usually','uucp','v','value','various','very','via','viz','vs','w','want','wants','was','wasn\'t','way','we',
             ...
             'you\'ll','you\'re','you\'ve','your','yours','yourself','yourselves','z','zero','&amp']

trafficBadKW = ['heavy', 'congestion', 'traffic', 'slow', 'chaos', 'serious', 'bad', 'death', 'injury',
                'injuries', 'collision', 'killed', 'crash', 'crashed', 'hit', 'crowded', 'car damaged', 'cars damaged',
                'broken', 'parade', 'block', 'stuck', 'police activity','hate']

trafficGoodKW = ['no traffic', 'light traffic']

accidentBadKW = ['accident', 'wrecked', 'crash']

#  for transformation from word to number representation
month_atn = {'Mar': 3, 'Jan': 1, 'Feb': 2, 'Apr': 4, 'May': 5, 'Jun': 6, 'Jul': 7, 'Aug': 8, 'Sep': 9, 'Oct': 10,
             'Nov': 11, 'Dec': 12}
month_nts = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']
days_month = {'Mar': 31, 'Jan': 31, 'Feb': 28, 'Apr': 30, 'May': 31, 'Jun': 30, 'Jul': 31, 'Aug': 31, 'Sep': 30,
              'Oct': 31, 'Nov': 30, 'Dec': 31}
index_struct_time = {'tm_year': 0, 'tm_mon':1, 'tm_mday':2, 'tm_hour':3,'tm_min': 4, 'tm_sec': 5, 'tm_wday': 6,
                     'tm_yday': 7, 'tm_isdst': 8}